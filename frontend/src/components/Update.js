...
function Update() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async ()=>{
      const res = await axios.get(`https://important-flip-flops-fawn.cyclic.cloud/api/posts/${id}`)
  ...
  const handleSubmit =async (e)=>{
    ...
    toggleProcess()
    const res = await axios.patch(`https://important-flip-flops-fawn.cyclic.cloud/api/posts/${id}`,{title,description:des,code,author,tags:array,email})
    toggleProcess()
